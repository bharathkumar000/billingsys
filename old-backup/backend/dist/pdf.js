...
exports.compileBilingualInvoicePDF = compileBilingualInvoicePDF;
...
function compileBilingualInvoicePDF(items, sessionTitle, res, customerName = '', invoiceDate = '', destination = '', dispatchedThrough = '', termsOfDelivery = '', consigneeName = '', consigneeAddress = '', consigneeGstin = '', buyerAddress = '', buyerGstin = '') {
    // Use a custom layout format. A4 width: 595, height: 842. Margins: 30.
    const doc = new pdfkit_1.default({ size: 'A4', margin: 30 });
    doc.pipe(res);
    const fontPath = path_1.default.join(__dirname, '..', 'assets', 'fonts', 'NotoSansKannada-Regular.ttf');
...
function renderInvoicePage(doc, items, opt) {
